 ...
 class Page{
   ...
   return $url;
    ...
    public function limit(){
        return 'limit ' . ($this->_page-1)*$this->_showpage . ',' . ($this->_showpage);
    }
    ...
    private function first(){
        if($this->_page>1){
            ...
            $pagebanner .= "&nbsp;&nbsp;<a href='{$this->_uri}pageid=".($this->_page-1)."'>上一页</a>&nbsp;&nbsp;";
            return $pagebanner;
        } else {
            $pagebanner = '&nbsp;&nbsp;首页&nbsp;&nbsp;';
            $pagebanner .= '&nbsp;&nbsp;上一页&nbsp;&nbsp;';
    ...
    private function end(){
        if($this->_page != $this->_total_pages){
            $pagebanner = "&nbsp;<a href='{$this->_uri}pageid=". ($this->_page+1) ."'>下一页</a>&nbsp;&nbsp;";
            $pagebanner .= "&nbsp;<a href='{$this->_uri}pageid=". ($this->_total_pages) ."'>末页</a>&nbsp;&nbsp;";
            return $pagebanner;
        } else {
            $pagebanner = '&nbsp;&nbsp;下一页&nbsp;&nbsp;';
            $pagebanner .= '&nbsp;&nbsp;末页&nbsp;&nbsp;';
    ...
    public function show(){
        $page_banner = "总记录数为:{$this->_total} 页数:{$this->_total_pages} " . $this->first() . $this->end();
        return $page_banner;
    }
 }
